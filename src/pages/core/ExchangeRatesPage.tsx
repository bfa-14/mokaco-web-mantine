...
const RATE_TYPES = ['Official', 'Market']
...
function ExchangeRatesGrid({ rows }: { rows: ExchangeRate[] }) {
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor('rateType', {
        header: 'Type',
        meta: { filterOptions: optionsFrom(rows, (r) => r.rateType) },
      }),
...
export default function ExchangeRatesPage() {
  ...
  /** PORT NOTE: Validator/RequiredRule → the same required checks and messages, run in submit(). */
