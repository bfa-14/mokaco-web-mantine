...
function useCounter(initialValue = 0, options) {
	...
	return [count, {
		increment: (0, import_react.useCallback)(() => setCount((current) => clamp(current + 1, min, max)), [min, max]),
		decrement: (0, import_react.useCallback)(() => setCount((current) => clamp(current - 1, min, max)), [min, max]),
...
function useDebouncedValue(value, wait, options = { leading: false }) {
	...
	const cancel = (0, import_react.useCallback)(() => window.clearTimeout(timeoutRef.current), []);
	(0, import_react.useEffect)(() => {
...
function useMouse(options = { resetOnExit: false }) {
	...
	const setMousePosition = (event) => {
		if (ref.current) {
			...
			const x = Math.max(0, Math.round(event.pageX - rect.left - (window.scrollX || window.scrollX)));
			const y = Math.max(0, Math.round(event.pageY - rect.top - (window.scrollY || window.scrollY)));
			setPosition({
				x,
				y
			});
...
var eventListerOptions = { passive: true };
...
//#endregion
export { useMove as $, useSetState as A, shallowEqual as At, useWindowScroll as B, useTextSelection as C, useColorScheme as Ct, useDisclosure as D, useDebouncedCallback as Dt, useFocusWithin as E, useClickOutside as Et, useFullscreen as F, useResizeObserver as G, useToggle as H, useHotkeys as I, usePageLeave as J, useScrollIntoView as K, getHotkeyHandler as L, useValidatedState as M, randomId as Mt, useHover as N, lowerFirst as Nt, useEventListener as O, useCallbackRef as Ot, useLogger as P, clamp as Pt, clampUseMovePosition as Q, useHash as R, usePrevious as S, useCounter as St, useNetwork as T, useClipboard as Tt, useShallowEffect as U, useViewportSize as V, useElementSize as W, usePagination as X, useQueue as Y, useUncontrolled as Z, useMutationObserver as _, useDocumentVisibility as _t, normalizeRadialValue as a, useSessionStorage as at, useHeadroom as b, useDebouncedValue as bt, useOrientation as c, useWindowEvent as ct, useThrottledState as d, useIdle as dt, useMouse as et, useThrottledCallback as f, useId as ft, useMounted as g, useDidUpdate as gt, useStateHistory as h, useFocusReturn as ht, useScrollSpy as i, readSessionStorageValue as it, useOs as j, range$1 as jt, useInputState as k, upperFirst as kt, useIsFirstRender as l, useListState as lt, useMap as m, useFocusTrap as mt, useLongPress as n, mergeRefs as nt, useRadialMove as o, readLocalStorageValue as ot, useSet as p, useForceUpdate as pt, useReducedMotion as q, useFileDialog as r, useMergedRef as rt, useFetch as s, useLocalStorage as st, useSelection as t, assignRef as tt, useThrottledValue as u, useInterval as ut, useInViewport as v, useDocumentTitle as vt, useTimeout as w, useMediaQuery as wt, useFavicon as x, useDebouncedState as xt, useEyeDropper as y, useIsomorphicEffect as yt, useIntersection as z };
